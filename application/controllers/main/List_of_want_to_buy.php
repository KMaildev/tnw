...
class List_of_want_to_buy extends CI_Controller
{
    ...
    public function index($offset = 0)
    {
        $config = [
            ...
            'total_rows' => $this->list_of_want_to_buy_model->count_all(),
            'per_page' => 50,
        ...
        $data["list_of_want_to_buys"] = $this->list_of_want_to_buy_model->getAll($config['per_page'], $offset);
        $data["count_all"] = $this->list_of_want_to_buy_model->count_all();
    ...
    public function destroy($id)
    {
        ...
        redirect(base_url('main/list_of_want_to_buy'));
    }
