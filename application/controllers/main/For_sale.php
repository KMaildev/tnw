...
class For_sale extends CI_Controller
{
    ...
    {
        $config = [
            'base_url' => base_url('main/for_sale/index'),
            'total_rows' => $this->for_sale_model->count_all(),
            'per_page' => 50,
        ...
        $data["for_sales"] = $this->for_sale_model->getAll($config['per_page'], $offset);
        $data["count_all"] = $this->for_sale_model->count_all();
        $this->load->view('admin/for_sale/index', $data);
    }
    ...
    public function save()
    {
        ...
        if ($this->form_validation->run() === FALSE) {
            ...
            $data["insert_id"] =  $this->for_sale_model->insert($data);
    ...
    public function detail($id)
    {
        ...
        $this->load->view('admin/for_sale/detail', $data);
    }

    public function destroy($id)
    {
        $this->for_sale_model->destroy_properties($id);
        $this->for_sale_model->destroy_propertie_photo($id);
    ...
    public function edit($id)
    {
        ...
        $data["detail"] = $this->for_sale_model->getDataById($id);
        $data["members"] = $this->developers_model->getAllMember();
        $this->load->view('admin/for_sale/edit', $data);
    }
    ...
    public function update()
    {
        ...
        if ($this->form_validation->run() === FALSE) {
            ...
            $this->for_sale_model->update($data);
    ...
    public function photo_edit($id)
    {
        $data["photos"] = $this->for_sale_model->getDataByPhoto($id);
        $data['insert_id'] = $id;
        $this->load->view('admin/for_sale/photo_edit', $data);
    }
    ...
    {
        $this->for_sale_model->changeStatusActive($id);
        redirect($_SERVER['HTTP_REFERER']);
    }

    public function changeStatusInactive($id)
    {
        $this->for_sale_model->changeStatusInactive($id);
        redirect($_SERVER['HTTP_REFERER']);
    }
}
