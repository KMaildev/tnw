                        ...
                        <div class="card2 card border-0 px-4">
                            ...
                            <div class="row mb-4 px-3">
                                <h3 class="mb-0 mr-4 mt-2" style="font-size: 23px;">
                                    <?php 
                                        echo ($lang_session) ? "အကြံဉာဏ်ပေးရန်" : "Suggestion Letter for Improving Services";
                                    ?>
                                </h3>
                                ...
                                <?php 
                                    if ($lang_session) {
                                        echo "ကျွန်ုပ်တို့သည် ကျွန်ုပ်တို့၏ ဝဘ်ဆိုဒ်၊ မိုဘိုင်းအက်ပ်နှင့် အရာများကို လုပ်ဆောင်ပုံတို့ကို အဆက်မပြတ် မြှင့်တင်နေပါသည်။ ကျွန်ုပ်တို့၏ဝန်ဆောင်မှုများကို ပိုမိုတိုးတက်ကောင်းမွန်လာစေရန် သင်၏အကြံပြုချက်များကို နွေးထွေးစွာကြိုဆိုပါသည်။ သင့်အကြံပြုချက်ကို အောက်တွင်တင်ပြနိုင်ပါသည်။";
                                    }else{
                                        echo "We are constantly improving our website, mobile app and how we do things. We warmly welcome your suggestions to improve our services further.You can submit your suggestion below.";
                                    }

                                    if ($lang_session) {
                                        $message = "သင်အကြံပေးလိုသော အကြောင်းအရာ";
                                    }else{
                                        $message = "What you want to suggest";
                                    }
                            ...
                            <div class="row px-3"> 
                                ...
                                <input class="mb-2" type="text" name="name" placeholder="<?php echo $name; ?>" autocomplete="off" value="<?php echo set_value('name'); ?>"> 
                            </div>
                            ...
                            <div class="row px-3"> 
                                ...
                                <input class="mb-2" type="text" name="phone" placeholder="<?php echo $phone; ?>" autocomplete="off" value="<?php echo set_value('phone'); ?>"> 
                            </div>


                            <div class="row px-3">
                                <label class="mb-1">
                                    <h6 class="mb-0 text-sm">Suggestion</h6>
                                </label> 
                                <textarea class="mb-2" placeholder="<?php echo $message; ?>" name="message"  autocomplete="off"></textarea>
                            </div>
