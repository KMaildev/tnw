...
<section class="recently portfolio home18" style="background-color: white;">
    <div class="container">
        <div class="section-title ml-4">
            <p style="font-size: 23px;">
                <?php 
                    if ($lang_session) {
                        echo "အခြား အိမ်ခြံမြေ များ";
                    }else{
                        echo "Find More Similar Properties";
                    }
                 ?>
            </p>
        </div>
                                        ...
                                        <a href="<?php echo site_url('propertydetail/index/'.$propertie->sale_id); ?>" class="homes-img">
                                            ...
                                            <?php if ($propertie->photo == '') { ?>
                                                <?php 
                                                 ...
                                                 ?>
                                                    <img src="<?php echo(base_url()); ?>/uploads/<?php echo $tatnaywon->logo; ?>" style="width: 100%; height: 160px; object-fit:cover; object-position: center;" class="img-responsive">
                                                <?php }else{ ?>
                                                    <img src="<?php echo(base_url()); ?>/uploads/<?php echo $propertie->logo; ?>" style="width: 100%; height: 160px; object-fit:cover; object-position: center;" class="img-responsive">
                                                <?php } ?>
                                            <?php }else{ ?>
                                                <img src="<?php echo(base_url()); ?>/uploads/<?php echo $propertie->photo; ?>" class="img-responsive" style="width: 100%; height: 160px; object-fit:cover; object-position: center;">
                                            <?php } ?>
                                        </a>
                                    </div>
