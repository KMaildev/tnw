	...
	<div class="container-fluid">
		<div class="row clearfix">
			...
			<?php 
				...
				if ($property_member_data->user_info_id == $member_session_id) {
			?>
				<div class="col-lg-12">
					<div class="card">
						<div class="header">
			            ...
			            <div class="col-lg-3" style="padding: 20px;">
			                <div class="card text-white bg-warning  mb-3" style="width: 100%;">
			                  ...
			                  <div class="card-header">
			                      <a href="<?php echo(site_url('member/for_sale/photo_remove/'.$photo->propertie_id)); ?>" style="color: red;">Remove</a>
			                  </div>
			                </div>
			            </div>
			            <?php } ?>
