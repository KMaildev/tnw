    ...
    <div class="container px-1 px-md-5 px-lg-1 px-xl-5 py-5 mx-auto">
        <div class="row justify-content-center">
            <div class="col-lg-8" style="background-color: white">
                <form action="<?php echo site_url('member/forgot_password/reset_password'); ?>" method="post">
                    <div class="card2 card border-0 px-4 py-5">
                        ...
                        <div class="row px-3">
                            ...
                            <input class="mb-4" type="text" name="email" placeholder="Enter your Email Address" autocomplete="off" value="<?php echo set_value('email'); ?>">
                        </div>
