                                    ...
                                    <ul class="homes-list clearfix">
                                        ...
                                        <div class="float-right">
                                            ...
                                            if ($propertie->propertie_type == 'by_owner_for_sale') {
                                                echo "<span style='color: red; font-weight: bold;'>ပိုင်ရှင်ကိုယ်တိုင် ရောင်းမည်</span>";
                                            } elseif ($propertie->propertie_type == 'by_owner_for_rent') {
                                                echo "<span style='color: red; font-weight: bold;'> ပိုင်ရှင်ကိုယ်တိုင် ငှားမည်</span>";
