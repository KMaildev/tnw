            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        <form method="post" action="<?php echo site_url('main/latest_news/save') ?>" enctype='multipart/form-data'>
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <select class="form-control" name="news_category_id">
                                            ...
                                            ?>
                                                <option value="<?php echo $value->nc_id; ?>"><?php echo $value->title; ?></option>
                                            <?php } ?>
                                        </select>
                                    </div>
                                </div>
