    ...
    <div class="block-header">
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12">
                ...
                <a title="Edit" href="<?php echo (site_url('main/wanted_list/edit/' . $detail->w_id)); ?>" class="btn btn-round btn-sm" style="background-color: green;">
                    <i class="fa fa-edit"></i> Edit
                </a>

                <a title="Delete" href="<?php echo (site_url('main/wanted_list/destroy/' . $detail->w_id)); ?>" onclick="return confirm('Are you sure want to delete?')" class="btn btn-round btn-sm" style="background-color: #d7252b;">
                                        ...
                                        <td>
                                            ...
                                            ?>
                                                <span class="badge badge-success">
                                                    <a href="<?php echo (site_url('main/wanted_list/changeStatusActive/' . $detail->w_id)); ?>" style="color: green;">
                                                        Active
                                                    </a>
                                                </span>
                                            <?php } elseif ($detail->is_active == 0) { ?>
                                                <span class="badge badge-danger">
                                                    <a href="<?php echo (site_url('main/wanted_list/changeStatusInactive/' . $detail->w_id)); ?>" style="color: red;">
                                                        Inactive
                                                    </a>
                                                </span>
                                            <?php } ?>
