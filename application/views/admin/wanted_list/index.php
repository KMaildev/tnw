    ...
    <div class="block-header">
        <div class="row">
            <div class="col-lg-5 col-md-5 col-sm-12">
                <h2><?php echo strtoupper(str_replace('_', ' ', $type)); ?>
            ...
            <div class="col-lg-7 col-md-7 col-sm-12 text-md-right">
                <div class="inlineblock text-center m-r-15 m-l-15 hidden-md-down">
                    ...
                    <small class="col-white">Total : <?php echo count($list_of_posts); ?></small>
                </div>
        ...
        <div class="row clearfix">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="header">
                        <h2>
                            <a href="<?php echo (site_url('main/wanted_list/create/' . $type)); ?>" class="btn btn-warning btn-sm" title="Create" style="color: white;">
                                Create
                            </a>
                        </h2>
                    </div>
            ...
            <?php
            foreach ($list_of_posts as $list_of_want_to_buy) {
            ?>
                    ...
                    <div class="card" style="height: 260px;">
                        <div class="body">
                            ...
                            <div class="d-flex justify-content-between mt-3 p-1  bg-light">
                                <a href="<?php echo (site_url('main/wanted_list/detail/' . $list_of_want_to_buy->w_id)); ?>" title="<?php echo $list_of_want_to_buy->area_type; ?>">
                                    <i class="zmdi zmdi-view-dashboard mr-2"></i>
                                    <span><?php echo $list_of_want_to_buy->area; ?></span>
                                </a>
                                <a href="<?php echo (site_url('main/wanted_list/detail/' . $list_of_want_to_buy->w_id)); ?>" title="Status">
                                    <i class="zmdi zmdi-home mr-2"></i>
                                    <span> <?php echo $list_of_want_to_buy->property_status; ?></span>
                                </a>
                                <a href="<?php echo (site_url('main/wanted_list/detail/' . $list_of_want_to_buy->w_id)); ?>" title="Bedroom">
                            ...
                            <br>
                            <a href="<?php echo (site_url('main/wanted_list/detail/' . $list_of_want_to_buy->w_id)); ?>" class="btn btn-success btn-sm btn-block">View</a>
                        </div>
                    </div>
                </div>
            <?php } ?>
