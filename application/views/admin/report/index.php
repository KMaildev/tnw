        ...
        <div class="row">
            ...
            <div class="col-lg-7 col-md-7 col-sm-12 text-md-right">
                ...
                <ul class="breadcrumb float-md-right">
                    <li class="breadcrumb-item"><a href="<?php echo(site_url('include/report/admin_report')); ?>"><i class="fa fa-building"></i> Report</a></li>
                                                ...
                                                <div class="media-body">
                                                    <div class="media-heading">
                                                        ...
                                                        <span class="m-2" title="Remove">
                                                            <a href="<?php echo site_url('include/admin_report/destroy/'.$report->r_id); ?>"><i class="fa fa-trash" style="color: red;"></i></a>
                                                        </span>

                                                        <span class="m-2" title="Remove">
                                                            <a href="<?php echo site_url('main/for_sale/detail/'.$report->post_id); ?>"><i class="fa fa-eye" style="color: green;"></i></a>
                                                        </span>
