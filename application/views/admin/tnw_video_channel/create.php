            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        <form method="post" action="<?php echo site_url('main/tnw_video_channel/save') ?>" enctype='multipart/form-data'>
                            ...
                            <div class="row py-2">
                                <div class="col-sm-12">
                                    <h6><i class="fa fa-video"> Video</i></h6>
                                    <input class="form-control" type="file" id="formFile" name="single_file" accept="video/*" required="">
                                </div>
                            </div>
