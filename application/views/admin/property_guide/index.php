        ...
        <div class="row">
            ...
            <div class="col-lg-7 col-md-7 col-sm-12 text-md-right">
                ...
                <ul class="breadcrumb float-md-right">
                    <li class="breadcrumb-item"><a href=""><i class="fa fa-building"></i> Propertie Guide</a></li>
        ...
        <div class="row clearfix">
        	...
        	<div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="header">
                        <h2>
	                		<a href="<?php echo(site_url('main/property_guide/create')); ?>" class="btn btn-warning btn-sm" title="Create" style="color: white;">
	                			Create
	                		</a>
                        </h2>
                    </div>
            ...
            <?php
             ...
             ?>
             <a href="<?php echo site_url('main/property_guide/detail/'.$property_guide->pg_id); ?>">
                 ...
                 <div class="card" style="height: 350px;">
                     <div class="body">
                         ...
                         <h6 class="text-success mt-3"><?php echo $property_guide->upload_date; ?></h6>
                          <p class="mt-0">
                            <a href="<?php echo site_url('main/property_guide/detail/'.$property_guide->pg_id); ?>" class="col-blue-grey">
