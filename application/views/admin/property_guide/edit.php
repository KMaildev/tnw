            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        <form method="post" action="<?php echo site_url('main/property_guide/update') ?>" enctype='multipart/form-data'>

                            <input type="hidden" name="admin_id" value="<?php echo $this->session->userdata('admin_id'); ?>">
                            <input type="hidden" name="pg_id" value="<?php echo $detail->pg_id; ?>">
