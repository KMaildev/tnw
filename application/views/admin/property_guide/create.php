    ...
    <div class="block-header">
        <div class="row">
            <div class="col-lg-5 col-md-5 col-sm-12">
                <h2>Property Guide Add
                <small>Tat Nay Won</small>
                </h2>
            </div>
            <div class="col-lg-7 col-md-7 col-sm-12 text-md-right">
                <ul class="breadcrumb float-md-right">
                    <li class="breadcrumb-item"><a href="<?php echo site_url('main/property_guide'); ?>"><i class="fa fa-building"></i> Property Guide</a></li>
    ...
    <div class="container-fluid">
        <div class="row clearfix">
            <div class="col-lg-12">
                <div class="card">
                    <div class="header">
                        <h2><strong>Property Guide Add</strong> </h2>
                    </div>
                    <div class="body">
                        ...
                        <form method="post" action="<?php echo site_url('main/property_guide/save') ?>" enctype='multipart/form-data'>
                            ...
                            <div class="row py-2">
                                <div class="col-sm-12">
                                    ...
                                    <input class="form-control" type="file" id="formFile" name="single_file" accept=".png, .jpg, .jpeg" required="">
                                </div>
                            </div>
