            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        <form method="post" action="<?php echo site_url('main/events/update') ?>" enctype='multipart/form-data'>
                            <input type="hidden" name="e_id" value="<?php echo $detail->e_id; ?>">
                            <div class="row clearfix">
                                <div class="col-sm-12">
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <input required="" type="text" class="form-control" placeholder="25 Jan 2021 - 31 Jan 2021" autocomplete="off" name="e_date" value="<?php echo $detail->e_date; ?>">
                                    </div>
                                </div>

                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <input required="" type="text" class="form-control" placeholder="10 AM - 1.00 PM" autocomplete="off" name="e_time" value="<?php echo $detail->e_time; ?>">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <input required="" type="text" class="form-control" placeholder="Location" autocomplete="off" name="location" value="<?php echo $detail->location; ?>">
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <textarea id="summernote" name="description_eng"><?php echo $detail->description_eng; ?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <textarea id="summernoteeng" name="description_mm"><?php echo $detail->description_mm; ?></textarea>
                                </div>
                            </div>
                            ...
                            <div class="row py-2">
                                <div class="col-sm-12">
                                    ...
                                    <input type="hidden" name="single_file_value" value="<?php echo $detail->photo; ?>">
                                </div>
