    ...
    <div class="block-header">
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12">
                ...
                <a title="Edit" href="<?php echo (site_url('main/new_properties/edit/' . $detail->sale_id)); ?>" class="btn btn-primary btn-round btn-sm" style="background-color: green;">
                    <i class="fa fa-edit"></i> Edit
                </a>

                <a title="Edit Photo" href="<?php echo (site_url('main/new_properties/photo_edit/' . $detail->sale_id)); ?>" class="btn btn-round btn-sm" style="background-color: #034787;">
                    <i class="fa fa-file-image"></i> Photo Edit
                </a>

                <a title="Delete" href="<?php echo (site_url('main/new_properties/destroy/' . $detail->sale_id)); ?>" onclick="return confirm('Are you sure want to delete?')" class="btn btn-round btn-sm" style="background-color: #d7252b;">
                                        ...
                                        <td>
                                            ...
                                            ?>
                                                <span class="badge badge-success">
                                                    <a href="<?php echo (site_url('main/new_properties/changeStatusActive/' . $detail->sale_id)); ?>" style="color: green;">
                                                        Active
                                                    </a>
                                                </span>
                                            <?php } elseif ($detail->ad_status == 0) { ?>
                                                <span class="badge badge-danger">
                                                    <a href="<?php echo (site_url('main/new_properties/changeStatusInactive/' . $detail->sale_id)); ?>" style="color: red;">
                                                        Inactive
                                                    </a>
                                                </span>
                                            <?php } ?>
