        ...
        <div class="row clearfix">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="header">
                        <h2>
                            <a href="<?php echo (site_url('main/new_properties/create')); ?>" class="btn btn-warning btn-sm" title="Create" style="color: white;">
                                Create
                            </a>
                        </h2>
                    </div>
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-3 col-md-3 col-sm-12">
                                <div class="form-group">
                                    <form method="get" action="<?php echo site_url('main/new_properties/index'); ?>">
            ...
            foreach ($for_sales as $for_sale) {
                if ($for_sale->propertie_type == 'new_properties') {
            ?>
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="card" style="height: 260px;">
                            <div class="body">
                                <h5 class="mt-0">
                                    <a href="<?php echo (site_url('main/new_properties/detail/' . $for_sale->sale_id)); ?>" class="col-blue-grey">
                                ...
                                <div class="d-flex justify-content-between mt-3 p-3 bg-light">
                                    <a href="<?php echo (site_url('main/new_properties/detail/' . $for_sale->sale_id)); ?>" title="<?php echo $for_sale->area_type; ?>">
                                    ...
                                    <a href="<?php echo (site_url('main/new_properties/detail/' . $for_sale->sale_id)); ?>" title="Status">
                                        <i class="zmdi zmdi-home mr-2"></i>
                                        <span> <?php echo $for_sale->property_status; ?></span>
                                    </a>
                                    <a href="<?php echo (site_url('main/new_properties/detail/' . $for_sale->sale_id)); ?>" title="Bedroom">
                                ...
                                <br>
                                <a title="Detail" href="<?php echo (site_url('main/new_properties/detail/' . $for_sale->sale_id)); ?>" class="btn btn-primary btn-round btn-sm" style="background-color: gray;">
                                ...
                                <a title="Edit" href="<?php echo (site_url('main/new_properties/edit/' . $for_sale->sale_id)); ?>" class="btn btn-primary btn-round btn-sm" style="background-color: green;">
                                    <i class="fa fa-edit"></i> Edit
                                </a>

                                <a title="Edit Photo" href="<?php echo (site_url('main/new_properties/photo_edit/' . $for_sale->sale_id)); ?>" class="btn btn-round btn-sm" style="background-color: #034787;">
                                    <i class="fa fa-file-image"></i> Photo Edit
                                </a>

                                <a title="Delete" href="<?php echo (site_url('main/new_properties/destroy/' . $for_sale->sale_id)); ?>" onclick="return confirm('Are you sure want to delete?')" class="btn btn-round btn-sm" style="background-color: #d7252b;">
