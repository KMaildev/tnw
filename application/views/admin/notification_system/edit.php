            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        <form method="post" action="<?php echo site_url('main/notification_system/update') ?>" enctype='multipart/form-data'>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <textarea placeholder="Description" id="w3review" name="description" rows="4" cols="100%" style="width: 100%"><?php echo $detail->description; ?></textarea>
                                </div>
                            </div>
