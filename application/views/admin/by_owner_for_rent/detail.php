    ...
    <div class="block-header">
        <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-12">
                <?php 
                    if ($detail->user_info_id == 0) {
                ?>
                    <a title="Edit" href="<?php echo(site_url('main/for_sale/edit/'.$detail->sale_id)); ?>" class="btn btn-primary btn-round btn-sm" style="background-color: green;">
                        <i class="fa fa-edit"></i> Edit
                    </a>

                    <a title="Edit Photo" href="<?php echo(site_url('main/for_sale/photo_edit/'.$detail->sale_id)); ?>" class="btn btn-round btn-sm" style="background-color: #034787;">
                ...
                <a title="Delete" href="<?php echo(site_url('main/for_sale/destroy/'.$detail->sale_id)); ?>" onclick="return confirm('Are you sure want to delete?')" class="btn btn-round btn-sm" style="background-color: #d7252b;">
            ...
            <div class="col-lg-8 col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="body">
                        <div class="row clearfix">
                            <div class="col-sm-4">
                                <small><i><h6 class="py-2"><i class="fa fa-school"></i> Education</h6></i></small>
                                <ul class="list-group">
                                    <?php
                            ...
                            <div class="col-sm-4">
                                <small><i><h6 class="py-2"><i class="fa fa-first-aid"></i> Health & Medical</h6></i></small>
                                <ul class="list-group">
                                    <?php
                            ...
                            <div class="col-sm-4">
                                <small><i><h6 class="py-2"><i class="fa fa-bus"></i> Transportation</h6></i></small>
                                <ul class="list-group">
                                    <?php
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <span class="badge badge-success">
                                                <a href="<?php echo(site_url('main/for_sale/changeStatusActive/'.$detail->sale_id)); ?>" style="color: green;">
                                                    Active
                                                </a>
                                            </span>
                                            <?php }elseif($detail->ad_status == 0){ ?>
                                            <span class="badge badge-danger">
                                                <a href="<?php echo(site_url('main/for_sale/changeStatusInactive/'.$detail->sale_id)); ?>" style="color: red;">
                                                    Inactive
                                                </a>
                                            </span>
                                            <?php } ?>
