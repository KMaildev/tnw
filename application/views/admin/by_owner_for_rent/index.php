        ...
        <div class="row">
            ...
            <div class="col-lg-7 col-md-7 col-sm-12 text-md-right">
                ...
                <ul class="breadcrumb float-md-right">
                    <li class="breadcrumb-item"><a href="<?php echo (site_url('main/by_owner_for_rent')); ?>"><i class="fa fa-building"></i> By Owner For Rent</a></li>
        ...
        <div class="row clearfix">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="header">
                        <h2>
                            <a href="<?php echo (site_url('main/by_owner_for_rent/create')); ?>" class="btn btn-warning btn-sm" title="Create" style="color: white;">
                                Create
                            </a>
                        </h2>
                    </div>
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-3 col-md-3 col-sm-12">
                                <div class="form-group">
                                    <form method="get" action="<?php echo site_url('main/by_owner_for_rent/index'); ?>">
            ...
            foreach ($for_sales as $for_sale) {
                if ($for_sale->propertie_type == 'by_owner_for_rent') {
            ?>
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="card" style="height: 260px;">
                            <div class="body">
                                ...
                                <a title="Detail" href="<?php echo (site_url('main/for_sale/detail/' . $for_sale->sale_id)); ?>" class="btn btn-primary btn-round btn-sm" style="background-color: gray;">
                                ...
                                <a title="Edit" href="<?php echo (site_url('main/for_sale/edit/' . $for_sale->sale_id)); ?>" class="btn btn-primary btn-round btn-sm" style="background-color: green;">
                                    <i class="fa fa-edit"></i> Edit
                                </a>

                                <a title="Edit Photo" href="<?php echo (site_url('main/for_sale/photo_edit/' . $for_sale->sale_id)); ?>" class="btn btn-round btn-sm" style="background-color: #034787;">
                                    <i class="fa fa-file-image"></i> Photo Edit
                                </a>

                                <a title="Delete" href="<?php echo (site_url('main/for_sale/destroy/' . $for_sale->sale_id)); ?>" onclick="return confirm('Are you sure want to delete?')" class="btn btn-round btn-sm" style="background-color: #d7252b;">
