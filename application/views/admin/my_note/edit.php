            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        <form method="post" action="<?php echo site_url('main/note/update'); ?>" enctype='multipart/form-data'>

                            <input type="hidden" name="note_id" value="<?php echo $detail->np_id; ?>" required="">
