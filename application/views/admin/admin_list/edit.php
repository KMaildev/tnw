            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        <form method="post" action="<?php echo site_url('main/admin_list/update'); ?>">
                            <input type="hidden" name="admin_id" value="<?php echo $detail->id; ?>" required="">
                            <div class="row clearfix">
                                ...
                                <div class="col-sm-12 col-md-6">
                                    <div class="form-group">
                                        <input required="" type="text" class="form-control" placeholder="Email" autocomplete="off" name="email" value="<?php echo $detail->email; ?>">
                                    </div>
                                </div>
