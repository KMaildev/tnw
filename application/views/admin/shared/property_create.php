<div class="row clearfix py-3">
    <div class="col-sm-12 col-md-12 py-2">
        ...
        <?php
        if ($type == 'for_sale' || $type == 'for_rent' || $type == 'new_property') {
        ?>
        ...
        <?php
        if ($type == 'by_owner_for_rent' || $type == 'by_owner_for_sale') {
        ?>
            <div class="radio inlineblock m-r-25">
                <input type="radio" id="WonerBtn" name="upload_type" value="For_Owner" checked>
...
<div class="row clearfix py-3">
    ...
    <div class="col-sm-6">
        <div class="form-group">
            <input required="" type="number" class="form-control" placeholder="Price [Required]" autocomplete="off" name="price" value="<?php echo set_value('price'); ?>" min="0" list="suggests">
        </div>
    </div>
...
?>
    <div class="col-sm-6" hidden>
        ...
        <div class="radio inlineblock m-r-25">
            <input type="radio" name="slide_status" id="slide1" value="No" checked>
            <label for="slide1">No</label>
        </div>
        <div class="radio inlineblock">
            <input type="radio" name="slide_status" id="slide2" value="Yes">
