<div class="row clearfix py-3">
    <div class="col-sm-12 col-md-12 py-2">
        <div class="radio inlineblock m-r-25">
            <input type="radio" id="AdminBtnUpdateHostel" name="upload_type" value="Admin" <?php print ($detail->upload_type == 'Admin' || $detail->upload_type == NULL) ? 'checked=""' : ''; ?>>
            <label for="AdminBtnUpdateHostel">Admin</label>
        </div>
        <div class="radio inlineblock m-r-25">
            <input type="radio" id="AgentBtnUpdateHostel" name="upload_type" value="For_Agent" <?php print ($detail->upload_type == 'For_Agent') ? 'checked=""' : ''; ?>>
            <label for="AgentBtnUpdateHostel">For Agent</label>
        </div>

        <div class="radio inlineblock m-r-25">
            <input type="radio" id="WonerBtnUpdateHostel" name="upload_type" value="For_Owner" <?php print ($detail->upload_type == 'For_Owner') ? 'checked=""' : ''; ?>>
            <label for="WonerBtnUpdateHostel">For Owner</label>
        </div>
    </div>
</div>


<div class="row" id="ShowForAgentHostel" style="background-color: #f2f2f2; padding: 17px;">
    <div class="col-sm-6">
...
<div class="row" id="ShowForOwnerHostel" style="background-color: #f2f2f2; padding: 17px;">
    <div class="col-sm-12">
        <p style="color: blue;">
...
<div class="row">
    <div class="col-sm-12">
        ...
        <!-- <textarea id="summernote" name="description_mm">
            
        </textarea> -->
    </div>

    <div class="col-sm-12">
        <textarea placeholder="Description Myanmar" id="w3review" name="description_eng" rows="4" cols="100%" style="width: 100%"><?php echo $detail->description_eng; ?></textarea>

        <!-- <textarea id="summernoteeng" name="description_eng">
