        ...
        <div class="row">
            ...
            <div class="col-lg-7 col-md-7 col-sm-12 text-md-right">
                <ul class="breadcrumb float-md-right">
                    <li class="breadcrumb-item"><a href="<?php echo site_url('main/by_owner_for_sale'); ?>"><i class="zmdi zmdi-home"></i> Property Add</a></li>
                ...
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        <form method="post" action="<?php echo site_url('main/shared/property_create/save') ?>" enctype='multipart/form-data'>
                            ...
                            <input type="hidden" name="propertie_type" value="by_owner_for_sale">
                            <input type="hidden" name="ad_number" value="OS-">
