        ...
        <div class="row">
            ...
            <div class="col-lg-7 col-md-7 col-sm-12 text-md-right">
                ...
                <ul class="breadcrumb float-md-right">
                    <li class="breadcrumb-item"><a href="<?php echo (site_url('main/by_owner_for_sale')); ?>"><i class="fa fa-building"></i> By Owner For Sale</a></li>
        ...
        <div class="row clearfix">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="header">
                        <h2>
                            <a href="<?php echo (site_url('main/by_owner_for_sale/create')); ?>" class="btn btn-warning btn-sm" title="Create" style="color: white;">
                                Create
                            </a>
                        </h2>
                    </div>
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-3 col-md-3 col-sm-12">
                                <div class="form-group">
                                    <form method="get" action="<?php echo site_url('main/by_owner_for_sale/index'); ?>">
            ...
            foreach ($for_sales as $for_sale) {
                if ($for_sale->propertie_type == 'by_owner_for_sale') {
            ?>
