            ...
            <div class="col-lg-4 col-md-12">
                ...
                <?php } elseif ($detail->user_info_id == 0 and $detail->upload_type == 'For_Agent' || $detail->upload_type == 'For_Owner') { ?>
                    <div class="card">
                        <div class="body text-center">
                            <?php
                            if ($detail->agent_owner_logo != NULL) {
                            ?>
                            ...
                            <?php
                            if ($detail->user_contact_name != NULL) {
                            ?>
                                <h4 class="m-t-10">
                                    <?php echo $detail->user_contact_name; ?>
                                </h4>
                            <?php } ?>
                            <div class="col-12">
                                <?php
                                if ($detail->user_address != NULL) {
                                ?>
                                    <p style="text-align: justify;">
                                        <small>
                                            <i class="fa fa-map-marker"></i>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered m-b-0">
                                <tbody>
                                    ...
                                    <tr>
                                        <th scope="row">Master Bathroom:</th>
                                        <td><?php echo $detail->masterbathroom; ?></td>
                                    </tr>
