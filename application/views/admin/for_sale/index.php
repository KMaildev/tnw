        ...
        <div class="row clearfix">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12">
                <div class="card">
                    <div class="header">
                        <h2>
                            <a href="<?php echo (site_url('main/for_sale/create')); ?>" class="btn btn-warning btn-sm" title="Create" style="color: white;">
                                Create
                            </a>
                        </h2>
                    </div>
                        ...
                        <div class="row clearfix">
                            <div class="col-lg-3 col-md-3 col-sm-12">
                                <div class="form-group">
                                    <form method="get" action="<?php echo site_url('main/for_sale/index'); ?>">
            ...
            foreach ($for_sales as $for_sale) {
                if ($for_sale->propertie_type == 'for_sale' || $for_sale->propertie_type == 'by_owner_for_sale') {
            ?>
