            ...
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <div class="body">
                        ...
                        <form method="post" action="<?php echo site_url('main/testimonials/save') ?>" enctype='multipart/form-data'>
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-sm-12 col-md-4">
                                    <div class="form-group">
                                        <input required="" type="text" class="form-control" placeholder="Company Name or Posication" autocomplete="off" name="company" value="<?php echo set_value('company'); ?>">
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <textarea id="summernote" name="testimonial" required=""><?php echo set_value('testimonial'); ?></textarea>
                                </div>
                            </div>
