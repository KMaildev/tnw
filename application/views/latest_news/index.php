                                ...
                                <div class="project-inner project-head">
                                    <div class="homes">
                                        <a href="<?php echo site_url('latest_news/show/'.$propertie_guide->news_id); ?>" class="homes-img">
                                            ...
                                            <?php }else{ ?>
                                                <img src="<?php echo(base_url()); ?>/uploads/<?php echo $propertie_guide->photo; ?>" class="img-responsive" style="width: 100%; height: 160px; object-fit:cover; object-position: center;">
                                            <?php } ?>
                                        </a>
                                    </div>
                                </div>
