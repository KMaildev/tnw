                                ...
                                <div class="">
                                    <center>
                                        <?php 
                                            if ($detail->logo == '') {
                                         ?>
                                            <img src="<?php echo base_url(); ?>data/default/logo_not_found.png"  class="img-responsive" style="width: 130px!important; height: auto;">
                                        <?php }else{ ?>
                                            <img src="<?php echo base_url(); ?>uploads/<?php echo $detail->logo; ?>" alt="home-1" class="img-responsive w-150" style="width: 130px!important; border-radius: 50%;">
                                        <?php } ?>
                                    </center>
                                </div>
                            </a>
