            ...
            <div class="col-md-9 col-sm-12 blog-pots">
                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <?php 
                        if (!$properties) {
                            if ($lang_session) {
                                echo "သင်ရှာဖွေနေသော အချက်အလက်များ ရှာမတွေ့ပါ . . .";
                            }else{
                                echo "Data not found";
                            }
                        }
                ...
                <div class="row featured -items">
                    ...
                    <?php 
                     ...
                     ?>
                        ...
                        <div class="col-md-7 homes-content" >
                            ...
                            <div class="footer">
                                <span>
                                    <a title="View Detail" href="<?php echo site_url('propertydetail/index/'.$propertie->sale_id); ?>" class="btn  btn-sm" style="height: 30px; box-shadow: 0 8px 16px 0 rgba(0,0,0,0.2), 0 6px 20px 0 rgba(0,0,0,0.19); color: white; background-color: green; margin: 3px;"> အသေးစိတ်ကြည့်ရန် </a>
                                    <?php 
                                        if ($propertie->user_info_id == 0) {
                                     ?>
                                    <button class="btn btn-default  btn-sm text-white" data-toggle="modal" data-target="#exampleModalTatnayWon<?php echo $propertie->sale_id; ?>" style="height: 30px; box-shadow: 0 8px 16px 0 rgba(0,0,0,0.2), 0 6px 20px 0 rgba(0,0,0,0.19); color: white; background-color: green; margin: 3px;">
                                        <i class="fa fa-phone-volume text-white"></i> 
                                        ကြော်ငြာပိုင်ရှင်သို့ဆက်သွယ်ရန်
                                    </button>
                                        ...
                                        <div class="modal-content">
                                          <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">
                                                <small>ကြော်ငြာနံပါတ် <?php echo $propertie->ad_number; ?> အတွက် ဆက်သွယ်ရန် ဖုန်းနံပါတ်</small>
                                            </h5>
                                          </div>
                                          <div class="modal-body">
                                            <p><i class="fa fa-phone-volume"></i>  <?php echo $tatnaywon->phone; ?></p>
                                            <p><i class="fa fa-envelope"></i>  <?php echo $tatnaywon->email; ?></p>
                                            <p>
                                    ...
                                    <div class="modal fade" id="exampleModalTatnayWon<?php echo $propertie->sale_id; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                      <div class="modal-dialog" role="document">
                                        <div class="modal-content">
                                          ...
                                          <div class="modal-body">
                                            <p><i class="fa fa-phone-volume"></i>  <?php echo ($propertie->phone == '') ? "No Data" : $propertie->phone; ?></p>
                                            <p><i class="fa fa-envelope"></i>  <?php echo ($propertie->email == '') ? "No Data" : $propertie->email; ?></p>
                                            <p>
                                                <i class="fa fa-check-square"></i>  
                                                <?php 
                                                    echo $propertie->area; 
                    ...
                    <?php }else{ ?>
                        ...
                        <div class="col-md-7 homes-content" >
                            ...
                            <ul class="homes-list clearfix">
                                ...
                                <div class="price-properties">
                                    <?php 
                                        if ($propertie->user_info_id == 0) {
                                     ?>
                                        <!--<img src="<?php echo(base_url()); ?>/uploads/<?php echo $tatnaywon->logo; ?>" style="width: 100px; height: auto; padding: 2px;  box-shadow: 0px 4px 4px 3px #dbdfe0;">-->
                                    <?php }else{ ?>
                                        <!--<img src="<?php echo(base_url()); ?>/uploads/<?php echo $propertie->logo; ?>" style="width: 100px; height: auto; padding: 2px;  box-shadow: 0px 4px 4px 3px #dbdfe0;">-->
                                    <?php } ?>
                                </div>
                            </ul>
                            ...
                            <div class="footer">
                                <span>
                                    <a title="View Detail" href="<?php echo site_url('propertydetail/index/'.$propertie->sale_id); ?>" class="btn  btn-sm" style="height: 30px; box-shadow: 0 8px 16px 0 rgba(0,0,0,0.2), 0 6px 20px 0 rgba(0,0,0,0.19); color: white; background-color: green; margin: 3px;"> 
                                    ...
                                    <?php }else{ ?>
                                    <button class="btn btn-default  btn-sm text-white" data-toggle="modal" data-target="#exampleModalTatnayWon<?php echo $propertie->sale_id; ?>">
                                        <i class="fa fa-phone-volume text-white"></i> 
                                        Click To Call Advertiser
                                    </button>
                                    <div class="modal fade" id="exampleModalTatnayWon<?php echo $propertie->sale_id; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <?php } ?>
                <div class="row featured -items py-1">
