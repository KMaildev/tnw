                    ...
                    <div class="col-md-12 col-xs-12">
                        <div class="news-item details no-mb2">
                            <div class="news-item-img">
                                <img class="img-responsive" src="<?php echo base_url(); ?>uploads/<?php echo $detail->photo; ?>" alt="<?php echo $detail->title; ?>" style="width: 100%; height: 300px; object-fit:cover; object-position: center;">
                            </div>
...
<section class="similar-property recently portfolio bshd p-0 bg-white-inner py-5">
    <div class="container">
        <h5>Related Property Guide</h5>
        <div class="row portfolio-items">
            <?php 
                foreach ($recent_guides as $propertie_guide) {
             ?>
            <div class="item col-lg-3 col-md-3 col-xs-12 col-sm-12 landscapes">
