<?php
class By_owner_for_sale_model extends CI_Model
{
    ...
    public function getAll($limit, $offset)
    {
        ...
        if ($keyword) {
            $this->db->like(array('townships.townships' => $keyword));
        ...
        $this->db->where(array('propertie_type' => 'by_owner_for_sale', 'soldout_status' => 0));
        $this->db->order_by("ad_number ", "DESC");
    ...
    public function count_all()
    {
        ...
        if ($keyword) {
            ...
            $this->db->or_like(array('townships.townships' => $keyword));
        }
    ...
    public function insert($data)
    {
        ...
        $arr['ad_number'] = $this->input->post('ad_number');
